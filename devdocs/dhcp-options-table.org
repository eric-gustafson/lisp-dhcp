...
#+BEGIN_SRC lisp :var ltable=dhcp-options :tangle "../dhcp-options-table.lisp"  
    (in-package :dhcp)
...
* TODO Add hex column for code
* TODO links to the encode/decode funtions from table
* TODO Encode/Decode generated from single declaration?
  Why can't we?  
